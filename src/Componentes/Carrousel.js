                ...
                <div className="col-xs-12 col-sm-6 col-md-4 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-light-blue btn-md">$80.000</button>
                        </div>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-4 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-light-blue btn-md">$50.000</button>
                        </div>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-4 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-light-blue btn-md">Desde $30.000</button>
                        </div>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-4 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-light-blue btn-md">$20.000</button>
                        </div>
                    </div>
                </div>
            </div>
